INSERT INTO subscription_account (id, account_id, last_processed, run_frequency_minutes, state) VALUES
    ('2f797c16-053e-41ab-b40d-24356480e61e', gen_random_uuid(),  NULL, 30, 1),
    ('4c7e63ee-43a9-486d-ae38-d3e086593613', gen_random_uuid(),  NULL, 30, 2),
    ('5859fc2f-9eed-4e09-b653-5a63d3b100c0', gen_random_uuid(),  NULL, 30, 3);
