...
func TestGetSubscriptionUsageWithoutJwtReturns401(t *testing.T) {
	...
	resp, err := apiClient.GetSubscriptionsSubscriptionId(context.Background(), "be372162-c0a0-4903-a9e1-a0b372bb1de9", func(ctx context.Context, req *http.Request) error {
		return nil
	})
	if err != nil {
		t.Fatal(err)
